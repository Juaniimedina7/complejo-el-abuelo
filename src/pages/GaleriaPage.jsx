    ...
    <section className="mx-auto max-w-6xl px-4 py-14 sm:px-6">
      ...
      <div className="grid grid-cols-2 gap-3 sm:gap-4 md:grid-cols-3 lg:grid-cols-4">
        {items.map((g, i) => (
          ...
          >
            <img src={g.src} alt={g.alt} loading="lazy" className="size-full object-cover transition-transform duration-500 group-hover:scale-110" />
            <span className="absolute inset-0 flex items-end bg-gradient-to-t from-profundo/70 to-transparent p-3 opacity-0 transition-opacity group-hover:opacity-100">
